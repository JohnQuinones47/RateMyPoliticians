<?php 
function findPoliticans($address,$fedral,$state,$county,$sublocal){
...
echo '
<table class="table">
<h4>Federal Level Politicians</h4>
...
$url = "https://civicinfo.googleapis.com/civicinfo/v2/representatives?address=".$address."&levels=administrativeArea2&key=AIzaSyCRrgB_tfAuHfpeMSn9ZQK1_Pv6fo0isNE";
...
echo '
<table class="table">
<h4>County Level Politicians</h4>
<thead class="thead-dark">
<tr>
      <th scope="col"></th>
      <th scope="col">Politician</th>
...
$address=str_replace(" ","%",$address);
$url = "https://civicinfo.googleapis.com/civicinfo/v2/representatives?address=".$address."&levels=locality&key=AIzaSyCRrgB_tfAuHfpeMSn9ZQK1_Pv6fo0isNE";
$curl = curl_init($url);
curl_setopt($curl, CURLOPT_URL, $url);
curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
$headers = array(
